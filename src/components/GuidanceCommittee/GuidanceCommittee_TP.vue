<template>
  <el-container>
    <el-header style="height:40px" class="as_title">
      培养方案{{this.tp_year}}-{{this.tp_major}} | 查看培养方案
      <hr/>
    </el-header>

    <el-main style="background-color: white; border-radius: 5px;">
      <!--初始化培养方案模块-->
      <TrainingProgramInfo></TrainingProgramInfo>
    </el-main>
  </el-container>
</template>

<script>
  import TrainingProgramInfo from "../Entity/TrainingProgram/TrainingProgramInfo.vue"
    export default {
