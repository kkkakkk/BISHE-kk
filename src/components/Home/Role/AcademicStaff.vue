      ...
      <el-container class="base">
        <el-aside  width="13%">
          ...
          <div class="aside_left_margin">
            <AcademicStaff_Header ></AcademicStaff_Header>
          </div>
        </el-aside>
...
<script>
  ...
  import AcademicStaff_Header from "../../AcademicStaff/AcademicStaff_Header";
...
<style scoped>
  ...
  .aside_main{
    border-radius: 5px;
    background-color: rgba(139, 165, 192, 0.9);
    margin-left:10px;
    margin-right:10px;
    margin-bottom: 10px;
