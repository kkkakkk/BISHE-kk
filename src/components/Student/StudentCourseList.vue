<template>
  <div class="main_container">
    ...
    <span style="float: left;margin-left: 10px;font-weight: bold; margin-bottom: 10px;font-size: 16px">我上的课</span>
    ...
    <div>
      ...
      <el-row>
        <el-col :span="6" v-for="(course_item,index) in course_list" :key="index"  v-if="course_item.status==0" :offset="0" >
          ...
          <el-card class="box-card_waittingforstart" shadow="hover" >
...
<style scoped>
  ...
  .box-card_waittingforstart {
    width: 320px;
    margin: 10px 10px 10px 10px;
    background-color: rgba(217, 220, 223, 0.68);
  }
